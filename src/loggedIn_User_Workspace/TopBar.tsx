...
export const TopBar = (prop: {userChannelAndDirectMsgDetails: WorkspaceUserDetails} ) => {
          ...
          <div className="relative hover: cursor-pointer" onClick={(e) => {
            ...
            {userStatus && <div className="absolute h-80 w-80 top-10 right-0 flex flex-col justify-between bg-slate-100 rounded-md text-black" onClick={(e) => e.stopPropagation()}>
              <div className="border-b border-slate-400 pb-4">
                <div>{prop.userChannelAndDirectMsgDetails && prop.userChannelAndDirectMsgDetails.displayName}</div>
            ...
            <div className="bg-cyan-400 rounded-md px-4 py-0.5 font-bold">{prop.userChannelAndDirectMsgDetails && prop.userChannelAndDirectMsgDetails.displayName}</div>
